...
(
    ...
    [Created] DATETIME2 CONSTRAINT [DF_GdprPDS_Created] DEFAULT SYSUTCDATETIME() NOT NULL, 
...
GO;
CREATE UNIQUE NONCLUSTERED INDEX [IX_GdprPDS_DcdId] ON [dbo].[GdprPDS] ([DcdId])
GO;
CREATE UNIQUE CLUSTERED INDEX [IX_GdprPDS_Name] ON [dbo].[GdprPDS] ([DisplayName])
GO;
